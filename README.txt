===================================================================================================
This document contains a description and the install instruction for CSC wind data aquisition system
last updated: 08-29-2020
info: cyril: cyrilbiz@gmail.com
===================================================================================================


The system is built ontop of weewx. Weewx must already be installed and working acquiring data from the Vantage box located inside the clubhouse sending the data to wunderground.

The following system gets the data from weewx and sends it to be posted on csc website.
...
Jorrit Poelen then posts it to the csc appspot page.
...
1. download the folder wind2web to /home/admin
...
wee_extension --list should now return:
...
before continuing: now check that the file /home/admin/wind2web/data/cscVantageLoop.csv contains wind data updated constantly.
